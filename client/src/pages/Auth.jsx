    ...
    if (!isLogin) {
        try {
            ...
            if (response.ok) {
                ...
                setIsLogin(true); // On bascule automatiquement sur la connexion
            } else {
        ...
        // On fera la logique de CONNEXION juste après
        setMessage("⚠️ La connexion arrive bientôt !");
    }
  };
    ...
    <div className="min-h-screen pt-20 flex items-center justify-center bg-f1-dark px-4">
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button type="submit" className="w-full bg-f1-red hover:bg-red-700 text-white font-bold py-3 rounded uppercase tracking-wider transition-colors">
